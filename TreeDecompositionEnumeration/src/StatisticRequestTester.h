...
#define GENERATE_STATREQS() \
    ...
    StatisticRequest sr_count_pmc = StatisticRequest().set_single_pmc_alg().set_count_pmc(); \
    StatisticRequest sr_pmc = StatisticRequest().set_single_pmc_alg().set_pmc(); \
    StatisticRequest sr_ms_subgraph_count = StatisticRequest().set_single_pmc_alg().set_ms_subgraph_count(); \
    StatisticRequest sr_ms_subgraphs = StatisticRequest().set_single_pmc_alg().set_ms_subgraphs(); \
